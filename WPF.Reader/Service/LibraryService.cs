...
namespace WPF.Reader.Service
{
    public class LibraryService
    {
        ...
        public LibraryService()
        {
            ...
            new Genre() { Id = 4, Name = "Roman" },
            new Genre() { Id = 5, Name = "Classique" },
            new Genre() { Id = 6, Name = "Jeunesse" },
            new Genre() { Id = 7, Name = "Social" },
            new Genre() { Id = 8, Name = "Existentialiste" },
            new Genre() { Id = 9, Name = "Comique" },
            new Genre() { Id = 10, Name = "Anticipation" },
            new Genre() { Id = 11, Name = "Thriller" },
            new Genre() { Id = 12, Name = "Horreur" },
            new Genre() { Id = 13, Name = "Policier" },
            new Genre() { Id = 14, Name = "Mystère" },
            new Genre() { Id = 15, Name = "Drame" },
            new Genre() { Id = 16, Name = "Fantastique" },
            new Genre() { Id = 17, Name = "Historique" },
            new Genre() { Id = 18, Name = "Comédie" },
            new Genre() { Id = 19, Name = "Tragédie" },
            new Genre() { Id = 20, Name = "Poésie" }
            };
            ...
            new Book()
            {
                ...
                Author= "Håkan Nesser",
                Price= 19,
                Genres= new List<Genre>() {Local_Genres[0], Local_Genres[2] },
            ...
            new Book()
            {
                ...
                Author= "Lorem",
                Price= 19,
                Genres= new List<Genre>() { Local_Genres[16] },
            ...
            new Book()
            {
                ...
                Author= "David Gomez",
                Price= 19,
                Genres= new List<Genre>() { Local_Genres[7], Local_Genres[9] },
            ...
            new Book()
            {
                ...
                Author= "Léon Tolstoï",
                Price= 35,
                Genres= new List<Genre>() { Local_Genres[4], Local_Genres[16] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"},
            new Book()
            {
                Title= "1984",
                ...
                Price= 22,
                Genres= new List<Genre>() { Local_Genres[0], Local_Genres[9] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"},
            new Book()
            {
                Title= "L'étranger",
            ...
            new Book()
            {
                ...
                Price= 40,
                Genres= new List<Genre>() { Local_Genres[4], Local_Genres[6] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"},
            new Book()
            {
            ...
            new Book()
            {
                ...
                Author= "Oscar Wilde",
                Price= 20,
                Genres= new List<Genre>() { Local_Genres[4], Local_Genres[18]},
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;" },
            new Book()
            {
                ...
                Author= "Emile Zola",
                Price= 35,
                Genres= new List<Genre>() {Local_Genres[4], Local_Genres[13] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"},
            new Book()
            {
            ...
            new Book()
            {
                ...
                Author= "Mark Twain",
                Price= 21,
                Genres= new List<Genre>() { Local_Genres[4], Local_Genres[5] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"},
            new Book()
            {
            ...
            new Book()
            {
                ...
                Author= "Romain Gary",
                Price= 22,
                Genres= new List<Genre>() { Local_Genres[3], Local_Genres[6] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"  },
            new Book()
            {
                ...
                Author= "Boris Vian",
                Price= 18,
                Genres= new List<Genre>() { Local_Genres[3], Local_Genres[15] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"  },
            new Book()
            {
                Title= "Les Fourmis",
                ...
                Price= 32,
                Genres= new List<Genre>() { Local_Genres[3], Local_Genres[0] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"  },
            new Book()
            {
            ...
            new Book()
            {
                ...
                Author= "Paulo Coelho",
                Price= 27,
                Genres= new List<Genre>() { Local_Genres[3], Local_Genres[13] },
                Content="<h1>Chapitre 1 : Le commencement</h1> <p>Il &eacute;tait une fois un jeune gar&ccedil;on nomm&eacute; Tom, qui vivait dans un petit village au bord de la for&ecirc;t. Un jour, en explorant la for&ecirc;t, Tom a d&eacute;couvert un arbre magique qui lui a accord&eacute; un v&oelig;u. Tom a souhait&eacute; devenir un h&eacute;ros pour aider les gens de son village.</p> <p>Le lendemain, Tom a &eacute;t&eacute; approch&eacute;"  },
            new Book()
            {
        ...
        public void PopulateCollection()
        {
            ...
            foreach (Genre genre in Local_Genres)
            {
                Genres.Add(genre);
            }
        }
